...
var urldb = "mongodb://test:test@ds029675.mlab.com:29675/test";
var url_for_invite = "http://test.org/diagnostic/sat="
...
function sendInvite(obj){
    ...
    var mailOptions = {
                            ...
                            'When you have finished all sections of the diagnostic test and clicked the ‘Submit’ button at the end of Section 4, the Test website will generate a score report and send it to your email at ' + email +
                            '\n\nGood Luck!',
                            attachments: [{
...
function createReport(results){
	...
	var mailOptions = {
                            ...
                            text: 'Dear ' + name + ' ' + surname + ',\n\nCongratulations on completing the Diagnostic SAT Test. Please find your results attached below.\n\n',
                            attachments: [{
